...
| **Versión** | v1.0 |
| **Fecha** | 14/05/2026 |
| **Documento padre** | `team/Marlene/03_prd/PRD.md` |
| **Historias** | `team/Marlene/03_prd/user_stories.md` |
| **Journeys** | `team/Marlene/03_prd/user_journeys.md` |
| **Release documental** | `team/Marlene/10_aportes/release-1.0.0.md` |
...
| Release notes | 2026-10 | `release-1.0.0.md` |
...
El **cronograma CEUB** de cada carrera (autoevaluación, revisión DUEA, entrega) es independiente del roadmap de software, pero el despliegue debe **anticiparse** a la ventana de carga:
...
*Mantener sincronizado con `user_stories.md` (prioridades) y `user_journeys.md` (validación UX).*
