# ADR-0004: Autenticación Stateless con JWT y RBAC por Rol Institucional

> **Copia de trabajo (equipo AcredIA).** ADR canónico del repositorio: [`docs/adr/ADR-0007-jwt-rbac-authentication.md`](../../../../docs/adr/ADR-0007-jwt-rbac-authentication.md). La numeración local `004` = repo **ADR-0007**.
