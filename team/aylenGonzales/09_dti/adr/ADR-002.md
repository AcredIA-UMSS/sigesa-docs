# ADR-0002: Log de Auditoría como Tabla Append-Only en PostgreSQL

> **Copia de trabajo (equipo AcredIA).** ADR canónico del repositorio: [`docs/adr/ADR-0005-audit-log-append-only-postgresql.md`](../../../../docs/adr/ADR-0005-audit-log-append-only-postgresql.md). La numeración local `002` = repo **ADR-0005**.
