# ADR-0001: Almacenamiento de Archivos de Evidencia en Sistema de Archivos Local (Volumen Docker)

> **Copia de trabajo (equipo AcredIA).** ADR canónico del repositorio: [`docs/adr/ADR-0004-evidence-blob-storage-docker.md`](../../../../docs/adr/ADR-0004-evidence-blob-storage-docker.md). La numeración local `001` no coincide con `ADR-0004` del repo.
