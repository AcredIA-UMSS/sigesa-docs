# ADR-0003: PostgreSQL 16 como Base de Datos Principal

> **Copia de trabajo (equipo AcredIA).** ADR canónico del repositorio: [`docs/adr/ADR-0006-postgresql-16-primary-database.md`](../../../../docs/adr/ADR-0006-postgresql-16-primary-database.md). La numeración local `003` = repo **ADR-0006**.
