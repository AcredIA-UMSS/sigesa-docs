# ADR-0005: Taxonomías CEUB/ARCU-SUR como Configuración en Base de Datos (No Hardcodeadas en Código)

> **Copia de trabajo (equipo AcredIA).** ADR canónico del repositorio: [`docs/adr/ADR-0008-taxonomies-ceub-arcu-sur-database.md`](../../../../docs/adr/ADR-0008-taxonomies-ceub-arcu-sur-database.md). La numeración local `005` = repo **ADR-0008**.
