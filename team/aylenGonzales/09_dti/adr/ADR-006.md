# ADR-0006: Backend API con Node.js 20 y Express 4

> **Copia de trabajo (equipo AcredIA).** ADR canónico del repositorio: [`docs/adr/ADR-0009-backend-nodejs-express.md`](../../../../docs/adr/ADR-0009-backend-nodejs-express.md). La numeración local `006` = repo **ADR-0009**.
