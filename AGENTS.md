...
> Versión extendida de gobernanza: [`docs/08_agents/AGENTS.md`](docs/08_agents/AGENTS.md).  
...
└── .cursor/
    ├── skills/                  ← skills runtime (9 activas)
    └── rules/*.mdc              ← reglas globales (5)
```

**Código aplicativo producto v1.0:** repositorio separado (futuro). **Código en este repo:** POCs en `docs/pocs/` — materializa ADR-0003, ADR-0004.
...
**Runtime:** `.cursor/skills/<nombre>/SKILL.md` (9 skills). Catálogo: [`docs/08_agents/skills.md`](docs/08_agents/skills.md).
