...
> **Fuente de verdad:** [`docs/08_agents/AGENTS.md`](docs/08_agents/AGENTS.md) (Dorada v2.0, 2026-05-17).
...
**Resumen rápido:** 8 skills activas, 5 reglas `.mdc`, actores @ProductAgent, @ArchAgent, @DBAgent, @QaAgent, @VisualAgent. Documentación de producto en `docs/01_brd/` … `docs/09_trazabilidad/`.
